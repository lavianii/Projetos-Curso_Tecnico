...
public class CadastroDaos {
    ...
    //Metodo para verificar se o CPF ja cadastrado
    public static boolean cadastrado(String cpf) throws Exception {
        ...
        try {
            ...
            while (resultado.next()) {
                verificaCpf = resultado.getNString("Cpf");
            }
    ...
    public static void alterarEndereco(String cep, String complemento,int numeroCasa, String cpf) throws Exception {
        conection = new BDMySQL().bdmysql();
